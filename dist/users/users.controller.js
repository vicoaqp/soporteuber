...
const jwt_role_1 = require("../auth/jwt/jwt-role");
let UsersController = class UsersController {
    ...
    updateNotificationToken(id, user) {
        return this.usersService.update(id, user);
    }
...
__decorate([
    (0, has_roles_1.HasRoles)(jwt_role_1.JwtRole.CLIENT),
...
__decorate([
    (0, has_roles_1.HasRoles)(jwt_role_1.JwtRole.CLIENT),
    (0, common_1.Put)('notification_token/:id'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, update_user_dto_1.UpdateUserDto]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "updateNotificationToken", null);
__decorate([
    (0, has_roles_1.HasRoles)(jwt_role_1.JwtRole.CLIENT),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, jwt_roles_guard_1.JwtRolesGuard),
